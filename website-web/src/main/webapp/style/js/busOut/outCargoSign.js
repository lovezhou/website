...
$(function() {
	...
	jessrun.formSubmitOutCargo('carry_get','frm_cost','loadFormSubmit','数据保存中');
...
jessrun.formSubmitOutCargo=function(btnId,formId,loadClass,loadHtml){
...
function stateReadonly()
{
	...
	$("[id^='tr_']").each(function(){
		...
		$("#hid_cargoOutId_"+carryCargoId).attr("name","cargoList["+lineNo+"].cargoOutId");
