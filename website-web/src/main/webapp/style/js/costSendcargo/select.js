$(function() {
	...
	$("#chk_all").change(function(){
		...
		$("[id^='chk_top_']").each(function(){
			...
			var target_obj = parent.$("#tr_"+outdepotId);
			if($(this).attr("checked"))
			{
				//如果主页面元素不存在则添加
				if (target_obj.length <= 0)
				{
					var topTr = "<tr id='tr_"+outdepotId+"' outdepotId='"+outdepotId+"'>"+$("#tr_top_"+outdepotId).html()+"</tr>";
					//checkbox替换成button,
...
//上面页面删除方法
function remove_top_Tr(outdepotId)
{
}