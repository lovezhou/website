...
function stateReadonly()
{
	...
	$("[id^='tr_']").each(function(){
		...
		//更新提交控件名称
		$("#txt_costGetAgentAfterNow_"+carryId).attr("name","agentlist["+lineNo+"].costGetAgentAfterNow");
		$("#txt_costGetAgentAfterLoss_"+carryId).attr("name","agentlist["+lineNo+"].costGetAgentAfterLoss");
