...
<body class="easyui-layout">
	...
	<div region="south" align="center" split="false"  style="height:30px;background:#A9FACD;padding:9px; ">版权所有 Copyright © 科技公司 鄂ICP备13002219号</div>
	<div region="center" title="当前位置：首页" iconCls="icon-location" style="width:100%;height:100%;overflow: auto;">
	</div>
</body>
  <div id="pp" style="width:500px;height:150px;padding:10px;background:#fafafa;display: none;"/>
</html>
