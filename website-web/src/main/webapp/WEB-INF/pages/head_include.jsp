...
<link href="<c:url value="/js/easyui/themes/default/easyui.css" />" rel="stylesheet" type="text/css" />
<link href="<c:url value="/js/easyui/themes/icon.css" />" rel="stylesheet" type="text/css" />
