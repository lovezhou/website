...
<html>
  ...
  <body  style="margin: 0px">
	<table  id="grid" class="easyui-treegrid" style="width:100%;height:100%"
			url="<%=basePath%>/sysResources/query.json" data-options="rownumbers:true,singleSelect:true,autoRowHeight:true"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'id',width:100,formatter:rowformater" align="center">操作</th>
			  	   	  ...
			  	   	  <th field="pid" align="center" width="100">父菜单项 （根节点pid为0）</th>
			</tr>
		</thead>
	</table>
	<div id="tb" style="padding:5px;height:auto">
		...
		<div>
			  	   	  	...
			  	   	  	菜单url：<input id="txt_url" class="easyui-textbox" name="url" style="width:10%;height:20px">
			  	   	  	父菜单项 （根节点pid为0）：<input id="txt_pid" class="easyui-textbox" name="pid" style="width:10%;height:20px">
