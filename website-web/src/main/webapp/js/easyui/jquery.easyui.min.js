...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"该项不能为空！",invalidMessage:null,rules:{email:{validator:function(_2fa){
...
},message:"请输入一个有效的邮箱地址!"},url:{validator:function(_2fb){
...
},message:"请输入一个有效的网址！"},length:{validator:function(_2fc,_2fd){
...
}else if(opts.min==0&&val<opts.min){
	$(_315).val(opts.min.toFixed(opts.precision));
}else{
